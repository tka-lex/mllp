...
export default [
    ...
    },
    {
        ...
        rules: {
            ...
            '@typescript-eslint/no-unused-vars': ['warn', { argsIgnorePattern: '^_' }], // Enable TS version
            ...
            '@typescript-eslint/consistent-type-imports': ['error', { prefer: 'type-imports' }], // Enforce `import type`
